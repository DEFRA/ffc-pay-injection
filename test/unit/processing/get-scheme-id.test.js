const {
  SFI, SFIP, LumpSums, VetVisits, CS, BPS, FDMR, MANUAL, ES, FC, IMPS,
  SFI23, DELINKED, SFI_EXPANDED, COHT_REVENUE, COHT_CAPITAL
} = require('../../../app/constants/schemes')

const {
  SFI: SFI_NAME, SFIP: SFIP_NAME, LumpSums: LSES_NAME, VetVisits: AHWR_NAME,
  CS: CS_NAME, BPS: BPS_NAME, FDMR: FDMR_NAME, MANUAL: MANUAL_NAME,
  ES: ES_NAME, FC: FC_NAME, IMPS: IMPS_NAME, SFI23: SFI23_NAME,
  DELINKED: DELINKED_NAME, SFI_EXPANDED: SFI_EXPANDED_NAME,
  COHT_REVENUE: COHT_REVENUE_NAME, COHT_CAPITAL: COHT_CAPITAL_NAME
